		...
		if(kinectInitialized)
		{
			   ...
			   (computeUserMap != UserMapType.None && computeUserMap != UserMapType.RawUserDepth))
	        {
				if(usersMapRect.width == 0 || usersMapRect.height == 0)
				{
					...
					usersMapRect = new Rect(cameraRect.width - displayWidth -620, cameraRect.height-30, displayWidth, (float)(-displayHeight*0.9));
					Debug.Log( "111:"+cameraRect.width + displayWidth);
				}
